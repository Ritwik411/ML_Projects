# -*- coding: utf-8 -*-
"""
Created on Wed May 29 12:12:55 2019
...
features_habitat=ohe1.fit_transform(features).toarray()
features = features_habitat[:,1:]

ohe2 = OneHotEncoder(categorical_features=[-1])
features_habitat=ohe2.fit_transform(features).toarray()
features = features_habitat[:,1:]

ohe3 = OneHotEncoder(categorical_features=[-1])
features_habitat=ohe3.fit_transform(features).toarray()
features = features_habitat[:,1:]
